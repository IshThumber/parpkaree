...
const Footer = () => {
  return (
    ...
    <div className="w-full bg-fifth pt-5 text-white">
      <div className="mx-auto w-11/12 max-w-screen">
        <div className="grid gap-16 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="sm:col-span-2">
            ...
            <div className="mt-6 lg:max-w-sm">
              <p className="text-sm text-gray-200">
                Registered Address : 1/4, F/F Madanpur Khadar Opp Gate No.-2.
                Near Pocket-C Sarita Vihar, Delhi-110076
                <br /> <br />
                Head Office : House no. 22/634, Ground Floor. Lane-22, Madangir
                DDA Flats, South Delhi-11062, India
              </p>
          ...
          <div className="mt-1 -space-x-8 text-sm">
