...
//   return (
//     <>
//       <div class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-green-300">
//         <div class="relative flex items-center justify-between">
//           <Link to="/" aria-label="Company" title="Company" class="inline-flex items-center">
//             <span class="ml-2 text-xl font-bold tracking-wide text-gray-800">Paropkaree Foundation</span>
//           </Link>
...
//             <li>
//               <Link to="/" class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-deep-purple-accent-400">
//                 Home
//               </Link>
//             </li>
//             <li>
  ...
  return (
    <>
      <Menu open={isMenuOpen} handler={setIsMenuOpen} offset={{ mainAxis: 20 }} placement="bottom" allowHover={true}>
        <MenuHandler>
          <Typography as="div" variant="medium" className="font-normal">
            <ListItem
...
function NavList() {
  return (
    <List className="mt-4 mb-6 p-0 lg:mt-0 lg:mb-0 lg:flex-row lg:p-1 text-xl">
      <Typography as="a" href="#" variant="medium" color="blue-gray" className="font-normal">
...
export default function Example() {
  ...
  return (
    <Navbar className="mx-auto max-w-screen px-5 py-3 align-middle text-xl">
      <div className="flex items-center justify-between text-blue-gray-900 align-middle ">
        <Typography as="a" href="#" variant="h5" className="mr-4 cursor-pointer py-1.5 lg:ml-2">
